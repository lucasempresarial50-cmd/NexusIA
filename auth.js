// api/auth.js — Autenticação segura com JWT simples
...
// Usuários ficam numa env var USERS_JSON no Vercel
// Formato: [{"id":"1","email":"...","password":"sha256hash","name":"...","plan":"pro","active":true}]
function getUsers() {
  try {
